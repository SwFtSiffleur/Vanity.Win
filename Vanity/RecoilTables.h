#include "Features.h"
#ifndef _RECOIL_DATA_HPP
#define _RECOIL_DATA_HPP
...
{
	std::vector<Vector2> none_t = { {0.0, 0.0} };

	std::vector<Vector2> ak47_t = { {-69.0, 100.0},{10.0, 92.0},{-110.0, 83.0},{-85.0, 75.0},{0.0, 67.0},{33.0, 57.0},{58.0, 48.0},{76.0, 39.0},{84.0, 29.0},{85.0, 19.0},{76.0, 20.0},{60.0, 37.0},{34.0, 50.0},
	...
	std::vector<Vector2> lr300_t = { {-5.88604, 49.91794}, {-17.4990 , 61.77337},{-18.5691, 65.90758}, {-24.59519, 62.32076},{-33.35285, 51.09613}, {-25.29157, 41.16616},{-19.41173, 35.38332}, {-4.43821, 30.10056},{18.17255, 25.31769}, {34.33775, 21.03471},{40.05314, 17.25143}, {35.31853, 13.96823}, {20.13392, 11.25902}, {-0.87096, 9.84447},{-11.07738, 8.84336}, {-18.49688, 7.95758},
	...
	std::vector<Vector2> mp5_t = { {0, 43}, {0, 58}, {0, 65}, {25, 66}, {59, 58}, {63, 42}, {46, 27}, {3, 23}, {-37, 19}, {-47, 18}, {-40, 18}, {-8, 7}, {16, 12}, {28, 11},
	{35, 9}, {34, 8}, {25, 6}, {12, 0}, {-4, 2}, {-6, 2}, {-18, 0}, {-27, 5}, {-26, 0}, {-27, 0}, {-20, 0}, {-32, 0}, {-12, 0}, {-25, 0}, {-4, 0}, {0, 0}, {43, 0} };

	std::vector<Vector2> custom_t = { {-28, 52}, {-10, 53}, {0, 53}, {11, 44}, {20, 45}, {22, 42}, {17, 35}, {7, 30}, {-9, 27}, {-13, 28}, {-23, 22}, {-21, 21}, {-15, 24},
	{0, 13}, {20, 14}, {16, 12}, {29, 19}, {7, 6}, {11, 10}, {-4, 8}, {-8, 13}, {-7, 2}, {-13, 14} };

	std::vector<Vector2> thompson_t = { {-29, 63}, {-12, 61}, {9, 61}, {21, 55}, {25, 52}, {21, 43}, {5, 32}, {-16, 33}, {-24, 25}, {-24, 26}, {-14, 21}, {7, 17}, {16, 18},
	{23, 16}, {25, 17}, {8, 16}, {-5, 5}, {-13, 15}, {-14, 8} };

	std::vector<Vector2> semi_t = { {0, 75}, {0, 75} };

	std::vector<Vector2> m249_t = { {0,58}, {0,58} };

	std::vector<Vector2> python_t = { {0,140}, {0,140} };

	std::vector<Vector2> m39_t = { {0,68}, {0,68} };

	std::vector<double> control_ak = { 121.96149709966872,92.6333814724611,138.60598637206294,113.37874368443146,66.25151186427745,66.29530438019354,75.9327831420658,85.05526144256157,89.20256669256554,86.68010184667988,78.82145888317788,70.0451048111144,60.85979604582978,59.51642457624619,71.66762996283607,86.74060009403034,98.3363599080854,104.34161954944257,104.09299204005345,97.58780746901739,85.48062700875559,70.4889202349561,56.56417811530545,47.386907899993936,56.63787408680247,91.5937793023631,112.38667610336424,111.39338971888095,87.5067801164596 };
...
namespace WeaponData {
	struct {
		const double Delay = 133.3333333;
	}AK47;
	struct {
		const int Delay = 120;
	}LR300;
